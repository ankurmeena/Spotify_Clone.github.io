...
export default function Body({ headerBackground }) {
  ...
  const playTrack=async(id,
    ...
    track_number)=>{
      ...
      console.log(response.data+"fdsvxc");
          ...
          <div className="list">
            ...
            <div className="tracks">
              {selectedPlaylist.tracks.map(({
                ...
                return (
                  <div className="row" key={id} onClick={()=>playTrack(id,name,artists,image,duration,album,context_uri,track_number)}>
                    <div className="col">
                      <span>{index + 1}</span>
                    </div>
...
.playlist {
  ...
  .list{
      .header_row{
        display:grid;
        grid-template-columns:0.3fr 3fr  2.05fr 0.2fr;
        color:#dddcdc;
        margin:1rem 0 0 0;
        position:sticky;
        top:18vh;
